...
const upsellItems = [
  { icon: '💌', title: 'Einladungskarten', description: 'Im Design eurer Website' },
  { icon: '🪑', title: 'Tischaufsteller', description: 'Tischkarten & Menükarten' },
  { icon: '📄', title: 'Save the Date', description: 'Digitale & gedruckte Versionen' },
  { icon: '🎁', title: 'Weitere Drucksorten', description: 'Dankeskarten, Programme & mehr' },
];
...
const Section = styled.section`
  ...
  ${p => p.$themeId === 'gold' && css`background: linear-gradient(180deg, #0A0A0A 0%, #0D0B08 100%);`}
...
const NeonParallaxLine = styled(ParallaxElement)`
  ...
  background: linear-gradient(90deg, transparent, ${p => p.$color || '#00ffff'}, transparent);
  opacity: 0.3;
...
const Subtitle = styled.p`
  ...
  ${p => p.$themeId === 'editorial' && css`font-family: 'Inter', sans-serif; font-size: 1.1rem; color: #666;`}
  ${p => p.$themeId === 'gold' && css`font-family: 'Montserrat', sans-serif; font-size: 1rem; color: rgba(255,255,255,0.5);`}
  ${p => p.$themeId === 'botanical' && css`font-family: 'Lato', sans-serif; font-size: 1.1rem; color: #5A6B5A;`}
  ${p => p.$themeId === 'contemporary' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; color: #666;`}
  ${p => p.$themeId === 'luxe' && css`font-family: 'Montserrat', sans-serif; font-size: 0.9rem; color: #888;`}
  ${p => p.$themeId === 'neon' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1rem; color: rgba(255,255,255,0.5);`}
`;
...
const GoldCard = styled.div`
  background: ${p => p.$popular ? 'linear-gradient(135deg, rgba(212,175,55,0.08) 0%, rgba(212,175,55,0.02) 100%)' : 'rgba(255,255,255,0.02)'};
  border: 1px solid ${p => p.$popular ? 'rgba(212,175,55,0.5)' : 'rgba(212,175,55,0.15)'};
  padding: 50px 35px;
  position: relative;
  transition: all 0.4s ease;
...
const GoldCTA = styled.button`
  width: 100%;
  padding: 18px;
  background: ${p => p.$popular ? 'linear-gradient(135deg, #D4AF37, #F4D03F)' : 'transparent'};
...
const BotanicalCard = styled.div`
  ...
  box-shadow: ${p => p.$popular ? '0 30px 80px rgba(45,59,45,0.25)' : '0 10px 40px rgba(45,59,45,0.08)'};
...
const BotanicalFeature = styled.li`
  ...
  font-size: 0.9rem;
  color: ${p => p.$popular 
    ? (p.$highlight ? '#FFFFFF' : 'rgba(255,255,255,0.7)') 
    : (p.$highlight ? '#2D3B2D' : '#5A6B5A')};
  font-weight: ${p => p.$highlight ? '600' : '400'};
  padding: 10px 0;
  border-bottom: 1px solid ${p => p.$popular ? 'rgba(255,255,255,0.1)' : 'rgba(45,59,45,0.1)'};
  display: flex;
  align-items: center;
  gap: 10px;
...
const ContemporaryCard = styled.div`
  ...
  box-shadow: ${p => p.$popular ? '12px 12px 0 #FF6B6B' : '8px 8px 0 #0D0D0D'};
  position: relative;
  transition: all 0.3s ease;
  animation: ${p => !p.$popular && css`${contemporaryBounce} ${4 + p.$index * 0.5}s ease-in-out infinite`};
  ...
  &:hover {
    ...
    box-shadow: ${p => p.$popular ? '16px 16px 0 #FF6B6B' : '12px 12px 0 #0D0D0D'};
...
const ContemporaryFeature = styled.li`
  ...
  padding: 10px 0;
  border-bottom: 2px solid ${p => p.$popular ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)'};
...
const LuxeFeature = styled.li`
  ...
  font-size: 0.8rem;
  color: ${p => p.$popular 
    ? (p.$highlight ? '#B4A08C' : 'rgba(255,255,255,0.6)') 
    : (p.$highlight ? '#2A2A2A' : '#888')};
  padding: 10px 0;
  border-bottom: 1px solid ${p => p.$popular ? 'rgba(255,255,255,0.05)' : 'rgba(180,160,140,0.1)'};
  display: flex;
  align-items: center;
  gap: 10px;
...
const NeonPrice = styled.div`
  ...
  text-shadow: 0 0 20px ${p => p.$popular ? 'rgba(255,0,255,0.5)' : 'rgba(0,255,255,0.5)'};
  margin-bottom: 5px;
...
const UpsellTitle = styled.h3`
  ...
  ${p => p.$themeId === 'editorial' && css`font-family: 'Instrument Serif', Georgia, serif; font-size: 2rem; font-style: italic; color: #1A1A1A;`}
  ${p => p.$themeId === 'gold' && css`font-family: 'Cormorant Garamond', Georgia, serif; font-size: 2rem; font-weight: 300; color: #D4AF37;`}
  ${p => p.$themeId === 'botanical' && css`font-family: 'Playfair Display', Georgia, serif; font-size: 1.8rem; color: #2D3B2D;`}
  ${p => p.$themeId === 'contemporary' && css`font-family: 'Space Grotesk', sans-serif; font-size: 2rem; font-weight: 700; color: #FFFFFF; text-transform: uppercase;`}
  ${p => p.$themeId === 'luxe' && css`font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.8rem; font-weight: 300; color: #2A2A2A;`}
  ${p => p.$themeId === 'neon' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1.8rem; font-weight: 700; color: #ff00ff; text-shadow: 0 0 20px rgba(255,0,255,0.5);`}
`;

const UpsellSubtitle = styled.p`
  margin: 0 0 40px 0;
  
  ${p => p.$themeId === 'editorial' && css`font-family: 'Inter', sans-serif; font-size: 1rem; color: #666;`}
  ${p => p.$themeId === 'gold' && css`font-family: 'Montserrat', sans-serif; font-size: 0.85rem; color: rgba(255,255,255,0.5);`}
  ${p => p.$themeId === 'botanical' && css`font-family: 'Lato', sans-serif; font-size: 1rem; color: #5A6B5A;`}
  ${p => p.$themeId === 'contemporary' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1rem; color: rgba(255,255,255,0.6);`}
  ${p => p.$themeId === 'luxe' && css`font-family: 'Montserrat', sans-serif; font-size: 0.8rem; color: #888;`}
  ${p => p.$themeId === 'neon' && css`font-family: 'Space Grotesk', sans-serif; font-size: 0.9rem; color: rgba(255,255,255,0.5);`}
`;
...
const UpsellItem = styled.div`
  ...
  ${p => p.$themeId === 'editorial' && css`
    ...
    .title { font-family: 'Instrument Serif', Georgia, serif; font-size: 1.2rem; font-style: italic; color: #1A1A1A; margin: 0 0 5px 0; }
    .desc { font-family: 'Inter', sans-serif; font-size: 0.8rem; color: #999; }
  `}
  ${p => p.$themeId === 'gold' && css`
    .icon { font-size: 2.5rem; margin-bottom: 15px; filter: grayscale(100%) sepia(100%) saturate(300%); }
    .title { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.2rem; color: #FFFFFF; margin: 0 0 5px 0; }
    .desc { font-family: 'Montserrat', sans-serif; font-size: 0.7rem; color: rgba(255,255,255,0.4); }
  `}
  ${p => p.$themeId === 'botanical' && css`
    .icon { font-size: 2.5rem; margin-bottom: 15px; }
    .title { font-family: 'Playfair Display', Georgia, serif; font-size: 1.1rem; color: #2D3B2D; margin: 0 0 5px 0; }
    .desc { font-family: 'Lato', sans-serif; font-size: 0.85rem; color: #8B9D83; }
  `}
  ${p => p.$themeId === 'contemporary' && css`
    ...
    .title { font-family: 'Space Grotesk', sans-serif; font-size: 1rem; font-weight: 700; color: #0D0D0D; text-transform: uppercase; margin: 0 0 5px 0; }
    .desc { font-family: 'Space Grotesk', sans-serif; font-size: 0.75rem; color: rgba(0,0,0,0.6); }
  `}
  ${p => p.$themeId === 'luxe' && css`
    .icon { font-size: 2rem; margin-bottom: 15px; opacity: 0.7; }
    .title { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.2rem; color: #2A2A2A; margin: 0 0 5px 0; }
    .desc { font-family: 'Montserrat', sans-serif; font-size: 0.7rem; color: #B4A08C; }
  `}
  ${p => p.$themeId === 'neon' && css`
    border: 1px solid rgba(0,255,255,0.2);
    padding: 25px 20px;
    .icon { font-size: 2rem; margin-bottom: 10px; }
    .title { font-family: 'Space Grotesk', sans-serif; font-size: 1rem; font-weight: 600; color: #00ffff; margin: 0 0 5px 0; }
    .desc { font-family: 'Space Grotesk', sans-serif; font-size: 0.75rem; color: rgba(255,255,255,0.5); }
  `}
`;
...
function PricingSection() {
  ...
  const renderParallax = () => {
    switch (currentTheme) {
      case 'editorial':
        return (
          <ParallaxContainer>
            <EditorialParallaxText $top="10%" $left="-5%" $size="400px" $offset={parallaxOffset * 0.3}>€</EditorialParallaxText>
            <EditorialParallaxText $top="50%" $right="-10%" $size="300px" $offset={parallaxOffset * 0.5}>Premium</EditorialParallaxText>
          </ParallaxContainer>
        );
      case 'gold':
        return (
          <ParallaxContainer>
            <GoldParallaxOrb $top="5%" $left="10%" $size="400px" $offset={parallaxOffset * 0.4} />
            <GoldParallaxOrb $top="40%" $right="5%" $size="300px" $offset={parallaxOffset * 0.6} />
            <GoldParallaxOrb $top="70%" $left="30%" $size="350px" $offset={parallaxOffset * 0.3} />
          </ParallaxContainer>
        );
      case 'botanical':
        return (
          <ParallaxContainer>
            <BotanicalParallaxPlant $top="5%" $left="5%" $size="80px" $offset={parallaxOffset * 0.4}>🌿</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $top="30%" $right="8%" $size="60px" $offset={parallaxOffset * 0.6}>🌸</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $bottom="20%" $left="10%" $size="70px" $offset={parallaxOffset * 0.5}>🌺</BotanicalParallaxPlant>
          </ParallaxContainer>
        );
      case 'neon':
        return (
          <ParallaxContainer>
            <NeonParallaxLine $top="15%" $left="0" $width="50%" $offset={parallaxOffset * 0.4} $color="#00ffff" />
            <NeonParallaxLine $top="45%" $right="0" $width="40%" $offset={parallaxOffset * 0.6} $color="#ff00ff" />
            <NeonParallaxLine $top="75%" $left="20%" $width="60%" $offset={parallaxOffset * 0.3} $color="#00ffff" />
          </ParallaxContainer>
        );
      default:
        return null;
  ...
  const renderPricingCard = (tier, index) => {
    const priceDisplay = tier.price === 'Auf Anfrage' ? tier.price : `€${tier.price}`;
    
    switch (currentTheme) {
      case 'editorial':
        return (
          <EditorialCard key={tier.id} $popular={tier.popular}>
            {tier.popular && <EditorialPopularBadge>Bestseller</EditorialPopularBadge>}
            ...
            <EditorialFeatures>
              {tier.features.map((f, i) => (
                <EditorialFeature key={i} $highlight={f.highlight}>{f.text}</EditorialFeature>
              ))}
            </EditorialFeatures>
      ...
      case 'gold':
        return (
          <GoldCard key={tier.id} $popular={tier.popular}>
            {tier.popular && <GoldPopularBadge>✦ Bestseller ✦</GoldPopularBadge>}
            ...
            <GoldFeatures>
              {tier.features.map((f, i) => (
                <GoldFeature key={i} $highlight={f.highlight}>{f.text}</GoldFeature>
              ))}
            </GoldFeatures>
      ...
      case 'botanical':
        return (
          <BotanicalCard key={tier.id} $popular={tier.popular}>
            {tier.popular && <BotanicalPopularBadge>Bestseller</BotanicalPopularBadge>}
            <BotanicalTierName $popular={tier.popular}>{tier.name}</BotanicalTierName>
            <BotanicalTierSubtitle $popular={tier.popular}>{tier.subtitle}</BotanicalTierSubtitle>
            <BotanicalPrice $popular={tier.popular}>
              {priceDisplay}
              {tier.price !== 'Auf Anfrage' && <span> einmalig</span>}
            </BotanicalPrice>
            <BotanicalPriceNote $popular={tier.popular}>zzgl. MwSt.</BotanicalPriceNote>
            <BotanicalFeatures>
              {tier.features.map((f, i) => (
                <BotanicalFeature key={i} $highlight={f.highlight} $popular={tier.popular}>{f.text}</BotanicalFeature>
              ))}
            </BotanicalFeatures>
      ...
      case 'contemporary':
        return (
          <ContemporaryCard key={tier.id} $popular={tier.popular} $index={index}>
            {tier.popular && <ContemporaryPopularBadge>★ Bestseller</ContemporaryPopularBadge>}
            <ContemporaryTierName $popular={tier.popular}>{tier.name}</ContemporaryTierName>
            <ContemporaryTierSubtitle $popular={tier.popular}>{tier.subtitle}</ContemporaryTierSubtitle>
            <ContemporaryPrice $popular={tier.popular}>
              {priceDisplay}
              {tier.price !== 'Auf Anfrage' && <span> einmalig</span>}
            </ContemporaryPrice>
            <ContemporaryPriceNote $popular={tier.popular}>zzgl. MwSt.</ContemporaryPriceNote>
            <ContemporaryFeatures>
              {tier.features.map((f, i) => (
                <ContemporaryFeature key={i} $highlight={f.highlight} $popular={tier.popular}>{f.text}</ContemporaryFeature>
              ))}
            </ContemporaryFeatures>
            <ContemporaryCTA $popular={tier.popular}>{tier.cta}</ContemporaryCTA>
          </ContemporaryCard>
        );
      ...
      case 'luxe':
        return (
          <LuxeCard key={tier.id} $popular={tier.popular}>
            ...
            <LuxeTierSubtitle $popular={tier.popular}>{tier.subtitle}</LuxeTierSubtitle>
            ...
            <LuxeFeatures>
              {tier.features.map((f, i) => (
                <LuxeFeature key={i} $highlight={f.highlight} $popular={tier.popular}>{f.text}</LuxeFeature>
              ))}
            </LuxeFeatures>
      ...
      case 'neon':
        return (
          <NeonCard key={tier.id} $popular={tier.popular}>
            {tier.popular && <NeonPopularBadge>// BESTSELLER</NeonPopularBadge>}
            ...
            <NeonFeatures>
              {tier.features.map((f, i) => (
                <NeonFeature key={i} $highlight={f.highlight}>{f.text}</NeonFeature>
              ))}
            </NeonFeatures>
      ...
      <Container>
        <Header>
          ...
          <Title $themeId={currentTheme}>
            {currentTheme === 'contemporary' ? 'CHOOSE YOUR PLAN' : 
             currentTheme === 'neon' ? 'SELECT PACKAGE' :
             'Transparente Preise'}
          </Title>
          <Subtitle $themeId={currentTheme}>
            Investiert in eine Website, die so einzigartig ist wie eure Liebe. Alle Pakete beinhalten eure eigene Domain.
          </Subtitle>
        </Header>
        ...
        <UpsellSection $themeId={currentTheme}>
          <UpsellTitle $themeId={currentTheme}>
            {currentTheme === 'contemporary' ? 'PRINT ADD-ONS' : 'Passende Drucksorten'}
          </UpsellTitle>
          <UpsellSubtitle $themeId={currentTheme}>
            Erweitert euer digitales Erlebnis mit physischen Produkten im gleichen Design.
          </UpsellSubtitle>
          <UpsellGrid>
