...
function MarketingFooter() {
  ...
  const handleSocialClick = (platform) => {
    // Placeholder für Social Media Links
          ...
          <EditorialFooter>
            <EditorialTop>
              <EditorialBrand>
                ...
                <p className='tagline'>
                  Einzigartige Hochzeitswebsites für Paare, die keine
                  Kompromisse eingehen. Persönlich. Individuell. Premium.
                </p>
              ...
              <EditorialColumn>
                ...
                <ul>
                  <li>
                    <a href='mailto:hallo@sarahundiver.de'>
                      hallo@sarahundiver.de
                    </a>
                  </li>
                  <li>
            ...
            <EditorialBottom>
              <EditorialCopyright>
                © {currentYear} S&I. Alle Rechte vorbehalten.
              </EditorialCopyright>
              <EditorialSocials>
                <SocialButton
          ...
          <BotanicalFooter>
            ...
            <BotanicalTop>
              <BotanicalBrand>
                <div className='logo'>S & I</div>
                <p className='tagline'>
                  Natürlich schön. Persönlich gestaltet. Für den wichtigsten Tag
                  eures Lebens.
                </p>
              ...
              <BotanicalCTA>
                ...
                <p className='text'>
                  Lasst uns gemeinsam eure perfekte Hochzeitswebsite kreieren.
                </p>
          ...
          <ContemporaryFooter>
            <ContemporaryTop>
              <ContemporaryBrand>
                <div className='logo'>S&I</div>
                <p className='tagline'>
                  Bold websites for bold couples. No templates. No limits.
                </p>
              </ContemporaryBrand>
            ...
            <ContemporaryBottom>
              ...
              <ContemporarySocials>
                <SocialButton onClick={() => handleSocialClick("instagram")}>
                  IG
                </SocialButton>
                <SocialButton onClick={() => handleSocialClick("pinterest")}>
                  PIN
                </SocialButton>
              </ContemporarySocials>
              <ContemporaryMadeWith>
                Made with <span>♥</span>
              </ContemporaryMadeWith>
            </ContemporaryBottom>
          </ContemporaryFooter>
      ...
      case "luxe":
        return (
          <LuxeFooter>
            ...
            <LuxeBottom>
              <LuxeCopyright>
                © {currentYear} S&I · Impressum · Datenschutz
              </LuxeCopyright>
              <LuxeMadeWith>
                Made with <span>devotion</span>
              </LuxeMadeWith>
            </LuxeBottom>
          </LuxeFooter>
        )
          ...
          <NeonFooter>
            ...
            <NeonTop>
              <NeonBrand>
                <div className='logo'>S & I</div>
                <p className='tagline'>
                  Digital experiences for modern couples. Personal. Unique.
                  Premium.
                </p>
