...
const Section = styled.section`
  ...
  ${p => p.$themeId === 'botanical' && css`background: linear-gradient(180deg, #F8F6F0 0%, #FFFFFF 50%, #F8F6F0 100%);`}
...
const GoldQuote = styled.blockquote`
  ...
  &::after { bottom: 0; left: 50%; transform: translateX(-50%); }
`;
...
const BotanicalPlantDecor = styled.div`
  position: absolute;
    ...
    switch (currentTheme) {
          ...
          <EditorialWrapper>
            <EditorialImageSide>
              ...
              <EditorialFloatingQuote>
                <p className="quote">„Wir glauben, dass eure Hochzeitswebsite genauso einzigartig sein sollte wie eure Liebe."</p>
            ...
            <EditorialContentSide>
              ...
              <EditorialText>
                Als wir unsere eigene Hochzeit geplant haben, standen wir vor dem gleichen Problem wie ihr: Unzählige Template-Websites, die alle gleich aussehen. Unpersönlich. Austauschbar.
              </EditorialText>
              <EditorialText>
      ...
      case 'gold':
        return (
          <GoldWrapper>
            <ParallaxContainer>
              <GlowOrb $top="10%" $left="10%" $size="400px" $offset={parallaxOffset * 0.3} $color="rgba(212,175,55,0.1)" />
              <GlowOrb $top="60%" $right="5%" $size="300px" $offset={parallaxOffset * 0.5} $color="rgba(212,175,55,0.08)" />
            </ParallaxContainer>
            ...
            <GoldTextBlock>
              <GoldText>
                Was als Suche nach unserer eigenen perfekten Hochzeitswebsite begann, wurde zu einer <strong>Leidenschaft</strong>. Wir haben erlebt, wie frustrierend es ist, zwischen unpersönlichen Templates wählen zu müssen.
              </GoldText>
              ...
              <GoldText>
                Bei S&I steht <strong>persönliche Betreuung</strong> an erster Stelle. Kein Callcenter, kein Chatbot – nur wir. Wir lernen euch und eure Geschichte kennen und kreieren eine Website, die wirklich zu euch passt.
              </GoldText>
              
              <GoldText>
                Jedes Projekt ist für uns <strong>Herzensangelegenheit</strong>. Wir arbeiten erst dann weiter, wenn ihr vollkommen zufrieden seid. Das ist unser Versprechen.
              </GoldText>
            </GoldTextBlock>
      ...
      case 'botanical':
        return (
          <BotanicalWrapper>
            <ParallaxContainer>
              <FloatingHeart $top="10%" $left="5%" $size="50px" $offset={parallaxOffset * 0.3} $opacity={0.15}>🌿</FloatingHeart>
              <FloatingHeart $top="30%" $right="8%" $size="40px" $offset={parallaxOffset * 0.5} $delay="1s" $opacity={0.1}>🌸</FloatingHeart>
              <FloatingHeart $top="70%" $left="10%" $size="45px" $offset={parallaxOffset * 0.4} $delay="2s" $opacity={0.12}>🍃</FloatingHeart>
            </ParallaxContainer>
            ...
            <BotanicalInner>
              <BotanicalImageSection>
                ...
                <BotanicalFloatingCard>
                  ...
                  <p className="text">„Persönlich bedeutet für uns: Wir kennen eure Namen, eure Geschichte, eure Wünsche."</p>
                </BotanicalFloatingCard>
              </BotanicalImageSection>
              ...
              <BotanicalContent>
                ...
                <BotanicalHighlight>
                  ...
                  <p className="text">Bei uns seid ihr keine Nummer. Wir begleiten euch persönlich durch den gesamten Prozess – mit Herz, Zeit und voller Aufmerksamkeit.</p>
                </BotanicalHighlight>
      ...
      case 'contemporary':
        return (
          <ContemporaryWrapper>
            <ContemporaryBgText $top="30%" $rotate="-5deg">PERSONAL</ContemporaryBgText>
            <ContemporaryBgText $top="70%" $rotate="3deg">UNIQUE</ContemporaryBgText>
            ...
            <ContemporaryHero>
              ...
              <ContemporarySubtitle>
                Keine Agentur. Keine Templates. Nur wir – und unsere Mission, eure Liebe digital unvergesslich zu machen.
              </ContemporarySubtitle>
              ...
              <ContemporaryCards>
                <ContemporaryCard $index={0}>
                  ...
                  <p className="text">Ihr redet direkt mit uns. Immer. Bei jedem Schritt. Keine Callcenter, keine Chatbots.</p>
                </ContemporaryCard>
                <ContemporaryCard $index={1}>
                  <div className="icon">🎨</div>
                  <h3 className="title">Individuell</h3>
                  <p className="text">Jede Website ist ein Unikat. Wir designen nicht für die Masse, sondern für euch.</p>
                </ContemporaryCard>
                <ContemporaryCard $index={2}>
                  <div className="icon">❤️</div>
                  <h3 className="title">Leidenschaft</h3>
                  <p className="text">Wir lieben, was wir tun. Und das sieht man in jedem Detail eurer Website.</p>
                </ContemporaryCard>
              </ContemporaryCards>
              
              <ContemporarySignature>
                <div className="names">S & I</div>
                <div className="tagline">// Real People, Real Connection</div>
              </ContemporarySignature>
            </ContemporaryHero>
          </ContemporaryWrapper>
        );
      ...
      case 'luxe':
        return (
          <LuxeWrapper>
            <ParallaxContainer>
              <ParallaxElement as="div" $top="20%" $left="5%" $offset={parallaxOffset * 0.3} style={{width: '200px', height: '1px', background: 'linear-gradient(90deg, #B4A08C, transparent)'}} />
              <ParallaxElement as="div" $top="50%" $right="5%" $offset={parallaxOffset * 0.5} style={{width: '150px', height: '1px', background: 'linear-gradient(90deg, transparent, #B4A08C)'}} />
              <ParallaxElement as="div" $top="80%" $left="10%" $offset={parallaxOffset * 0.4} style={{width: '180px', height: '1px', background: 'linear-gradient(90deg, #B4A08C, transparent)'}} />
            </ParallaxContainer>
            ...
            <LuxeInner>
              ...
              <LuxeQuote>
                In einer Welt der Massenproduktion glauben wir an die Schönheit des Individuellen.
              </LuxeQuote>
              ...
              <LuxeGrid>
                <LuxeGridItem>
                  ...
                  <p className="text">Von Anfang bis Ende habt ihr direkten Kontakt zu uns. Wir sind eure Ansprechpartner – nicht ein anonymes Team.</p>
                </LuxeGridItem>
                <LuxeGridItem>
                  <div className="number">02</div>
                  <h3 className="title">Maßgeschneidert</h3>
                  <p className="text">Keine vorgefertigten Lösungen. Jedes Design wird individuell für euch und eure Geschichte entwickelt.</p>
                </LuxeGridItem>
                <LuxeGridItem>
                  <div className="number">03</div>
                  <h3 className="title">Zeitlose Qualität</h3>
                  <p className="text">Wir schaffen Websites, die auch in Jahren noch beeindrucken. Klassische Eleganz statt kurzlebiger Trends.</p>
                </LuxeGridItem>
              </LuxeGrid>
      ...
      case 'neon':
        return (
          <NeonWrapper>
            ...
            <ParallaxContainer>
              <GlowOrb $top="20%" $left="5%" $size="300px" $offset={parallaxOffset * 0.3} $color="rgba(0,255,255,0.1)" />
              <GlowOrb $top="60%" $right="10%" $size="250px" $offset={parallaxOffset * 0.5} $color="rgba(255,0,255,0.1)" />
            </ParallaxContainer>
            ...
            <NeonInner>
              <NeonContent>
                ...
                <NeonText>
                  Wir sind keine anonyme Agentur. Wir sind <strong>zwei Menschen</strong>, die glauben, dass eure Hochzeitswebsite mehr verdient als ein 08/15-Template.
                </NeonText>
                <NeonText>
                  Bei uns gibt es keine Ticket-Nummern und keine automatischen Antworten. Ihr bekommt <strong>uns</strong> – mit voller Aufmerksamkeit und Leidenschaft für Design.
                </NeonText>
                <NeonText>
                ...
                <NeonSignature>
                  <div className="names">S & I</div>
                  <div className="tagline">// Human connection in a digital world</div>
                </NeonSignature>
              </NeonContent>
              ...
              <NeonTerminal>
                ...
                <NeonTerminalContent>
                  <NeonCodeLine><span className="comment">// Das sind wir</span></NeonCodeLine>
                  <NeonCodeLine>{'{'}</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"names"</span>: <span className="string">"Sarah & Iver"</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"mission"</span>: <span className="string">"Einzigartige Websites"</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"approach"</span>: <span className="string">"100% persönlich"</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"templates"</span>: <span className="value">false</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"chatbots"</span>: <span className="value">false</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"callcenter"</span>: <span className="value">false</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"passion"</span>: <span className="value">true</span>,</NeonCodeLine>
                  <NeonCodeLine>  <span className="key">"love"</span>: <span className="value">Infinity</span></NeonCodeLine>
                  <NeonCodeLine>{'}'}</NeonCodeLine>
                </NeonTerminalContent>
              </NeonTerminal>
            </NeonInner>
