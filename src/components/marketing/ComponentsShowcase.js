...
const allComponents = [
  // Immer inklusive
  {
    icon: "🏠",
    title: "Hero Section",
    description: "Der erste Eindruck zählt – atemberaubend inszeniert.",
    included: true,
  },
  {
    icon: "💑",
    title: "Love Story",
    description: "Eure Geschichte, wunderschön erzählt.",
    included: true,
  },
  {
    icon: "💌",
    title: "RSVP",
    description: "Einfache Anmeldung für eure Gäste.",
    included: true,
  },
  {
    icon: "🔐",
    title: "Admin Login",
    description: "Verwaltet eure RSVP-Anmeldungen.",
    included: true,
  },
  // Optionale Komponenten
  {
    icon: "📅",
    title: "Timeline",
    description: "Euer Tagesablauf elegant dargestellt.",
  },
  {
    icon: "⏰",
    title: "Countdown",
    description: "Spannung bis zum großen Tag.",
  },
  {
    icon: "📸",
    title: "Galerie",
    description: "Eure schönsten Momente im Spotlight.",
  },
  {
    icon: "📍",
    title: "Location",
    description: "Interaktive Karten für alle Orte.",
  },
  {
    icon: "📝",
    title: "Gästebuch",
    description: "Liebevolle Nachrichten sammeln.",
  },
  {
    icon: "👔",
    title: "Dresscode",
    description: "Stilvolle Kleiderordnung kommuniziert.",
  },
  {
    icon: "💍",
    title: "Wedding Party",
    description: "Trauzeugen & Brautjungfern vorstellen.",
  },
  {
    icon: "🏨",
    title: "Unterkünfte",
  ...
  },
  {
    icon: "🎁",
    title: "Geschenke",
    description: "Wunschliste elegant präsentiert.",
  },
  {
    icon: "🎵",
    title: "Musikwünsche",
    description: "Gäste wählen die Playlist mit.",
  },
  { icon: "❓", title: "FAQ", description: "Alle Fragen vorab beantwortet." },
  {
    icon: "✉️",
    title: "Kontakt",
    description: "Direkte Kommunikation ermöglichen.",
  },
  {
    icon: "🚗",
    title: "Anfahrt",
    description: "Wegbeschreibung & Parkmöglichkeiten.",
  },
]
...
const LuxeCard = styled.div`
  ...
  animation: ${(p) =>
    p.$visible
      ? css`
          ${luxeFloat} ${4 + p.$index * 0.3}s ease-in-out infinite
        `
      : "none"};
...
const NeonScrollHint = styled.div`
  ...
  align-items: center;
  gap: 5px;
  animation: ${(p) => (p.$direction === "down" ? scrollBounce : scrollBounceUp)}
  ...
  const renderNeon = () => (
    <NeonWrapper ref={neonWrapperRef}>
      ...
      <NeonHeader>
        ...
        <Subtitle $themeId='neon'>
          Scrolle durch alle 17 Komponenten – 4 davon immer inklusive.
        </Subtitle>
      ...
      {allComponents.map((comp, i) => (
        <NeonSlide key={comp.title}>
          <NeonCard>
            ...
            <NeonCounter>
              [ {String(i + 1).padStart(2, "0")} /{" "}
              {String(allComponents.length).padStart(2, "0")} ]
            </NeonCounter>
          </NeonCard>
