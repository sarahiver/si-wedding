...
const usps = [
  {
    ...
    description: 'Keine kryptischen URLs – eure Hochzeitswebsite läuft auf eurer persönlichen Domain, die ihr behaltet.',
    highlight: 'Inklusive'
  },
  {
    id: 2,
    ...
    description: 'Jede Website wird von Grund auf für euch gestaltet. Keine zwei Paare haben die gleiche Seite.',
  ...
  },
  {
    ...
    description: 'Direkter Kontakt zu eurem Designer. Wir verstehen eure Vision und setzen sie perfekt um.',
  ...
  },
  {
    ...
    description: 'Eure Hochzeitsdetails bleiben privat. Nur eingeladene Gäste haben Zugang zur Website.',
    highlight: 'Sicher'
  },
  {
    id: 5,
    ...
    description: 'Hosting in Deutschland, volle Datenschutz-Konformität. Eure Gästedaten sind sicher.',
  ...
  },
  {
    ...
    description: 'Ob 50 oder 500 Gäste – keine künstlichen Beschränkungen, keine versteckten Kosten.',
    highlight: 'Unlimited'
  },
  {
    id: 7,
    ...
    description: 'Automatische Sprachumschaltung für Gäste aus aller Welt. DE, EN, FR und mehr.',
    highlight: 'Global'
  },
  {
    id: 8,
    ...
    description: 'Responsive Design, das auf Smartphone, Tablet und Desktop gleichermaßen beeindruckt.',
  ...
  },
  {
    ...
    description: 'Enterprise-Hosting für Ladezeiten unter 2 Sekunden. Auch bei vielen gleichzeitigen Besuchern.',
  ...
  },
  {
    ...
    description: 'Wir begleiten euch vom ersten Entwurf bis nach dem großen Tag. Änderungen jederzeit möglich.',
...
const BotanicalParallaxPlant = styled.div`
  ...
  transform: translateY(${p => p.$offset}px) rotate(${p => p.$rotate || '0deg'});
  transition: transform 0.1s ease-out;
  top: ${p => p.$top};
  left: ${p => p.$left};
  right: ${p => p.$right};
...
const Subtitle = styled.p`
  ...
  ${p => p.$themeId === 'editorial' && css`font-family: 'Inter', sans-serif; font-size: 1.1rem; color: #666; margin: 0;`}
  ${p => p.$themeId === 'gold' && css`font-family: 'Montserrat', sans-serif; font-size: 1rem; color: rgba(255,255,255,0.5); max-width: 600px; margin: 0 auto;`}
  ${p => p.$themeId === 'botanical' && css`font-family: 'Lato', sans-serif; font-size: 1.1rem; color: #5A6B5A; max-width: 600px; margin: 0 auto;`}
  ${p => p.$themeId === 'contemporary' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; color: rgba(255,255,255,0.6); max-width: 600px; margin: 0 auto;`}
  ${p => p.$themeId === 'luxe' && css`font-family: 'Montserrat', sans-serif; font-size: 0.9rem; color: #888; max-width: 500px; margin: 0 auto;`}
  ${p => p.$themeId === 'neon' && css`font-family: 'Space Grotesk', sans-serif; font-size: 1rem; color: rgba(255,255,255,0.5); max-width: 600px; margin: 0 auto;`}
`;
...
const BotanicalCard = styled.div`
  ...
  &:hover {
    transform: translateY(-15px) rotate(${p => (p.$index % 2 === 0) ? '1deg' : '-1deg'});
...
const ContemporaryCard = styled.div`
  ...
  min-width: 280px;
  background: ${p => {
    const colors = ['#FF6B6B', '#4ECDC4', '#FFE66D', '#95E1D3', '#F38181', '#AA96DA', '#6C5CE7', '#FFEAA7', '#74B9FF', '#FD79A8'];
  ...
  position: relative;
  animation: ${contemporaryBounce} ${p => 4 + (p.$index * 0.5)}s ease-in-out infinite;
...
const DomainSubtext = styled.p`
  ...
  ${p => p.$themeId === 'editorial' && css`font-family: 'Inter', sans-serif; font-size: 0.9rem; color: rgba(255,255,255,0.5);`}
  ${p => p.$themeId === 'gold' && css`font-family: 'Montserrat', sans-serif; font-size: 0.8rem; color: rgba(255,255,255,0.4);`}
  ${p => p.$themeId === 'botanical' && css`font-family: 'Lato', sans-serif; font-size: 0.9rem; color: rgba(255,255,255,0.6);`}
  ${p => p.$themeId === 'contemporary' && css`font-family: 'Space Grotesk', sans-serif; font-size: 0.9rem; color: #999; margin-top: 20px;`}
  ${p => p.$themeId === 'luxe' && css`font-family: 'Montserrat', sans-serif; font-size: 0.75rem; color: #B4A08C; letter-spacing: 0.1em;`}
  ${p => p.$themeId === 'neon' && css`font-family: 'Space Grotesk', sans-serif; font-size: 0.85rem; color: rgba(255,255,255,0.4);`}
`;
  ...
  const renderParallax = () => {
    switch (currentTheme) {
      case 'editorial':
        return (
          <ParallaxContainer>
            <EditorialParallaxNumber $top="5%" $left="-5%" $size="500px" $offset={parallaxOffset * 0.3}>01</EditorialParallaxNumber>
            <EditorialParallaxNumber $top="40%" $right="-10%" $size="400px" $offset={parallaxOffset * 0.5}>10</EditorialParallaxNumber>
            <EditorialParallaxNumber $top="70%" $left="20%" $size="300px" $offset={parallaxOffset * 0.2}>USP</EditorialParallaxNumber>
          </ParallaxContainer>
        );
      case 'gold':
        return (
          <ParallaxContainer>
            <GoldParallaxOrb $top="-10%" $left="10%" $size="400px" $offset={parallaxOffset * 0.4} $duration="10s" />
            <GoldParallaxOrb $top="30%" $right="5%" $size="300px" $offset={parallaxOffset * 0.6} $duration="12s" $delay="2s" />
            <GoldParallaxOrb $top="60%" $left="30%" $size="350px" $offset={parallaxOffset * 0.3} $duration="8s" $delay="1s" />
            <GoldParallaxOrb $top="80%" $right="20%" $size="250px" $offset={parallaxOffset * 0.5} $duration="14s" $delay="3s" />
          </ParallaxContainer>
        );
      case 'botanical':
        return (
          <ParallaxContainer>
            <BotanicalParallaxPlant $top="5%" $left="5%" $size="100px" $offset={parallaxOffset * 0.4} $rotate="-15deg" $duration="12s">🌿</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $top="15%" $right="8%" $size="80px" $offset={parallaxOffset * 0.6} $rotate="10deg" $duration="10s" $delay="1s">🍃</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $top="45%" $left="3%" $size="90px" $offset={parallaxOffset * 0.3} $rotate="20deg" $duration="14s" $delay="2s">🌸</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $top="55%" $right="5%" $size="70px" $offset={parallaxOffset * 0.5} $rotate="-10deg" $duration="11s" $delay="0.5s">🌺</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $bottom="15%" $left="10%" $size="85px" $offset={parallaxOffset * 0.4} $rotate="5deg" $duration="13s" $delay="1.5s">🌼</BotanicalParallaxPlant>
            <BotanicalParallaxPlant $bottom="10%" $right="12%" $size="95px" $offset={parallaxOffset * 0.35} $rotate="-20deg" $duration="9s" $delay="2.5s">🌾</BotanicalParallaxPlant>
          </ParallaxContainer>
        );
      case 'contemporary':
        return (
          <ParallaxContainer>
            <ContemporaryParallaxShape $top="10%" $left="5%" $size="200px" $offset={parallaxOffset * 0.5} $rotate="15deg" $color="rgba(255,107,107,0.2)" />
            <ContemporaryParallaxShape $top="30%" $right="10%" $size="150px" $round $offset={parallaxOffset * 0.3} $color="rgba(78,205,196,0.2)" />
            <ContemporaryParallaxShape $top="60%" $left="15%" $size="180px" $round $offset={parallaxOffset * 0.6} $color="rgba(255,230,109,0.2)" />
            <ContemporaryParallaxShape $top="75%" $right="5%" $size="120px" $offset={parallaxOffset * 0.4} $rotate="-20deg" $color="rgba(255,255,255,0.1)" />
          </ParallaxContainer>
        );
      case 'luxe':
        return (
          <ParallaxContainer>
            <LuxeParallaxLine $top="15%" $left="0" $width="40%" $offset={parallaxOffset * 0.3} />
            <LuxeParallaxLine $top="35%" $right="0" $width="30%" $offset={parallaxOffset * 0.5} />
            <LuxeParallaxLine $top="55%" $left="20%" $width="50%" $offset={parallaxOffset * 0.2} />
            <LuxeParallaxLine $top="75%" $right="10%" $width="35%" $offset={parallaxOffset * 0.4} />
            <LuxeParallaxLine $top="90%" $left="5%" $width="45%" $offset={parallaxOffset * 0.35} />
          </ParallaxContainer>
        );
      case 'neon':
        return (
          <ParallaxContainer>
            ...
            <NeonParallaxLine $top="20%" $left="0" $width="60%" $offset={parallaxOffset * 0.5} $color="#00ffff" />
            <NeonParallaxLine $top="40%" $right="0" $width="50%" $offset={parallaxOffset * 0.3} $color="#ff00ff" />
            <NeonParallaxLine $top="65%" $left="10%" $width="70%" $offset={parallaxOffset * 0.6} $color="#00ffff" />
            <NeonParallaxLine $top="85%" $right="5%" $width="40%" $offset={parallaxOffset * 0.4} $color="#ff00ff" />
          </ParallaxContainer>
        );
      default:
        return null;
          ...
          <BotanicalGrid>
            {usps.map((usp, index) => (
              <BotanicalCard key={usp.id} $index={index} $emoji={emojis[index]}>
                <BotanicalIcon $delay={`${index * 0.2}s`}>{usp.icon}</BotanicalIcon>
            ...
            <ContemporaryGrid>
              {usps.map((usp, index) => (
                <ContemporaryCard key={usp.id} $index={index}>
                  <ContemporaryNumber>{String(index + 1).padStart(2, '0')}</ContemporaryNumber>
                  <ContemporaryCardTitle>{usp.title}</ContemporaryCardTitle>
                  <ContemporaryDescription>{usp.description}</ContemporaryDescription>
                </ContemporaryCard>
              ))}
            </ContemporaryGrid>
          </ContemporaryWrapper>
          ...
          <NeonWrapper>
            <NeonTerminal>
              <NeonTerminalHeader>
                ...
                <NeonHeaderText>usp_features.exe — 10 modules loaded</NeonHeaderText>
              </NeonTerminalHeader>
              <NeonGrid>
                {usps.map((usp, index) => (
                  <NeonCard key={usp.id} $index={index}>
                    <NeonIndex>// MODULE_{String(index + 1).padStart(2, '0')}</NeonIndex>
      ...
      <Container>
        <Header $themeId={currentTheme}>
          ...
          <Title $themeId={currentTheme}>
            {currentTheme === 'contemporary' ? 'WHAT YOU GET' : 
             currentTheme === 'neon' ? '10 REASONS TO CHOOSE US' :
             'Was uns auszeichnet'}
          </Title>
        ...
        <DomainHighlight $themeId={currentTheme}>
          ...
          <DomainTitle $themeId={currentTheme}>
            {currentTheme === 'contemporary' ? 'YOUR OWN DOMAIN' : 'Eure eigene Domain – inklusive'}
          </DomainTitle>
